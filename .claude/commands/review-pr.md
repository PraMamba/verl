...
- CRITICAL level types (FSDP core, Megatron core, DCP)
- HIGH level types (distributed comm, DTensor, TP, SP/CP, trainer core)
- MEDIUM level types (tensor ops, workflow, API, compile, rollout, reward)
...
- detected_types: [FSDP_CORE, DISTRIBUTED_COMM, RAY_CONTROLLER, ...]
- risk_level: CRITICAL | HIGH | MEDIUM | LOW
- affected_files: [file1.py, file2.py, ...]
- identified_risks: [risk1, risk2, ...]
- related_frameworks: [fsdp, megatron, vllm, sglang, ray, ...]
```
...
- Framework-specific tasks (FSDP, Megatron, DCP, Ray, vLLM/SGLang)
...
| FSDP core      | \[FSDP_CORE, DISTRIBUTED_COMM, DTENSOR\]  | 4-8 Opus        |
| Cross-domain   | \[RAY_CONTROLLER, FSDP_CORE, TESTS\]      | 5-10 mixed      |
